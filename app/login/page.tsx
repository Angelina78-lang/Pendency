        ...
        <div className="min-h-screen bg-[#060606] flex items-center justify-center px-6 font-sans antialiased">
            ...
            <div className="w-full max-w-sm space-y-7">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <div className="flex justify-between items-center">
                            ...
                            <Link href="#" className="text-xs text-white/25 hover:text-white/50 transition-colors">Forgot?</Link>
                        </div>
                ...
                <p className="text-center text-sm text-white/25">
                    ...
                    <Link href="/signup" className="text-white/60 font-semibold hover:text-white transition-colors">
                        Sign up
                    </Link>
                </p>
            </div>
